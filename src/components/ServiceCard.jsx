...
const ServiceCard = ({ icon, title, description, link, delay }) => {
  ...
  return (
    <Link 
      ...
      className="group relative flex flex-col items-center justify-center overflow-hidden bg-white p-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl cursor-pointer max-w-sm rounded-lg mx-auto"
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center mx-auto max-w-md">
        <span className="grid h-20 w-20 place-items-center rounded-full bg-secondary transition-all duration-300 group-hover:bg-secondary">
          ...
          <img src="src/assets/car_service.svg" alt="Services Image" className='w-11'/>
        </span>
